    ...
    <div class="container">
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu nav-left">
                ...
                <li><a href="" class="sub-menu-item" target="_blank">ادمین</a></li>
...
<script src="{{asset('admin/assets/js/jdate.min.js')}}"></script>
<script src="{{asset('admin/assets/js/plugins/rangePlugin.js')}}"></script>
<script src="{{asset('admin/assets/js/fa.js')}}"></script>
<script src="{{asset('admin/assets/js/flatpickr.init.js')}}"></script>
<!-- Datepicker -->
<script src="{{asset('admin/assets/js/jquery.timepicker.min.js')}}"></script>
<script src="{{asset('admin/assets/js/timepicker.init.js')}}"></script>
<!-- Icons -->
